...
public class eConstraintWidget {
    public eView source;
    public eConstraint leftConstraint = null;
    public eConstraint rightConstraint = null;
    public eConstraint topConstraint = null;
    public eConstraint bottomConstraint = null;
    public eSizeConstraint horizontalSizeConstraint = null;
    public eSizeConstraint verticalSizeConstraint = null;
    ...
    public eConstraintWidget(eView source) {
        this.source = source;
    ...
    public void createStates() {
        ...
        if(horizontalSizeConstraint == null){
            horizontalSizeConstraint = new eFixedSizeConstraint(100);
        }
        if(verticalSizeConstraint == null){
            verticalSizeConstraint = new eFixedSizeConstraint(50);
        }
    }
    ...
    public void addEquation(Solver s) throws UnsatisfiableConstraintException, DuplicateConstraintException {
        ...
        if(horizontalSizeConstraint instanceof eFreeSizeConstraint ){
            if(centerHorizontal){
        ...
        if(horizontalSizeConstraint instanceof eFixedSizeConstraint) {
