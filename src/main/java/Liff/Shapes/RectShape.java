...
public class RectShape extends Shape{
    ...
    public RectShape(float sx, float sy, String textureName, Vector2f[] textureCoordinates){
        super(Arrays.asList(new Vertex(sx, 0, 0.0f, textureCoordinates[3].x, textureCoordinates[3].y), new Vertex(0, sy, 0.0f,textureCoordinates[0].x, textureCoordinates[0].y), new Vertex(sx, sy, 0.0f,textureCoordinates[2].x, textureCoordinates[2].y), new Vertex(0, 0, 0.0f,textureCoordinates[1].x, textureCoordinates[1].y)), Arrays.asList(2, 1, 0, 0, 1, 3), textureName);
    ...
    public void updateRectangle(Rectangle rect){
        setVertices(Arrays.asList(new Vertex(rect.sizeX, rect.posY,  0.0f, this.textureCoordinates[3].x, this.textureCoordinates[3].y),
                                  ...
                                  new Vertex(rect.sizeX, rect.sizeY, 0.0f, this.textureCoordinates[2].x, this.textureCoordinates[2].y),
                                  new Vertex(rect.posX,  rect.posY,  0.0f, this.textureCoordinates[1].x, this.textureCoordinates[1].y)));
